package com.macrosoft.common.baseFunction;
...
public class BaseFunction {
	...
	public static String[] strToArray(String str) {
		...
		try {
			...
			if (str.indexOf(CommonConst.SYS_SPLIT_COLON) >= 0) {
				...
				if (str.indexOf(CommonConst.SYS_SPLIT_SEMICOLON) >= 0) {
					splitStr = CommonConst.SYS_SPLIT_SEMICOLON;
				} else {
					if (str.indexOf(CommonConst.SYS_SPLIT_COMMA) >= 0) {
	...
	public static String[] strToArray(String str, String splitStr) {
		...
		try {
			...
			if (splitStr == null) {
				splitStr = CommonConst.SYS_NAME_SPLIT;
			}
