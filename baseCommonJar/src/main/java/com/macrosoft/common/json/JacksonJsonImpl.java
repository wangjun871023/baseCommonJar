  ...
  implements JsonInterface
{
  ...
  public Map<String, Object> sendObject(Object form, boolean success, String rootKey)
  {
    Map map = getInstanceMap();
    if (form != null) {
  ...
  public List<Object> parseObject(String jsonStr, Object object, String rootKey)
  {
  ...
  public static void main(String[] args) {
    ...
    GisGradeBean bean = new GisGradeBean();
    String test = "{\"14\":{\"standard\":[\"10km\",\"2.5km\"],\"user_defined\":[\"10km\"]}} ";
    List tempList2 = null;
    try
    {
      ObjectMapper mapper = new ObjectMapper();
